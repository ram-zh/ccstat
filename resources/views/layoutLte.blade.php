<?php
// TODO: extract this to view composer
...
<html lang="ru">
    <head>
        ...
        <link rel="stylesheet" href="{{ url('js/jquery-ui/jquery-ui.css') }}"/>
        ...
        <link rel="stylesheet" type="text/css" href="{{ url('js/jquery.dataTables.min.css') }}"/>

        <script type="text/javascript" src="{{ url('js/jquery.dataTables.min.js') }}"></script>

        <link rel="stylesheet" type="text/css" href="{{ url('js/select2/select2.min.css') }}"/>
        <script type="text/javascript" src="{{ url('js/select2/select2.min.js') }}"></script>
        <script type="text/javascript" src="{{ url('js/select2/i18n/ru.js') }}"></script>

        <script src="{{ url('main.js?v=' . $version) }}"></script>

        <link rel="stylesheet" href="{{ url('main.css?v=' . $version) }}"/>

        <link rel="stylesheet" href="{{ url('survey/css?v=' . $version) }}"/>
        <script src="{{ url('survey/js?v=' . $version) }}"></script>
